...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-05-2026 a las 05:01:57
...
INSERT INTO `actividades` (`actividad_id`, `tipo_actividad`, `fecha`, `usuario_id`, `hora_inicio`, `hora_fin`, `ubicacion`, `clima`, `estatus`, `creado_en`, `actualizado_en`) VALUES
(11, 1, '2026-05-28', 6, '06:27:00', '05:27:00', 'Cancha UPTP', NULL, 1, '2026-05-28 08:27:16', '2026-05-28 08:27:16'),
(12, 2, '2026-05-28', 4, NULL, NULL, 'Cancha Principal', NULL, 1, '2026-05-28 08:32:38', '2026-05-28 08:32:38'),
(13, 2, '2026-05-29', 6, NULL, NULL, 'Cancha Principal', NULL, 1, '2026-05-29 12:53:03', '2026-05-29 12:53:03'),
(14, 2, '2026-05-29', 4, NULL, NULL, 'Cancha Principal', NULL, 1, '2026-05-29 12:54:35', '2026-05-29 12:54:35'),
(15, 2, '2026-05-20', 8, NULL, NULL, 'Cancha Principal', NULL, 1, '2026-05-29 12:55:58', '2026-05-29 12:55:58');
...
--
-- Volcado de datos para la tabla `asig_categorias`
--

INSERT INTO `asig_categorias` (`asignacion_id`, `categoria_id`, `atleta_id`, `nun_dorsal`, `posicion_principal_id`, `posicion_secundaria_id`, `estatus`, `creado_en`, `actualizado_en`) VALUES
(6, 4, 10, 11, 7, 2, 1, '2026-05-29 17:25:57', '2026-05-29 21:24:33'),
(7, 9, 9, 9, 8, 7, 1, '2026-05-29 17:26:59', '2026-05-29 21:25:04'),
(9, 9, 11, 8, 9, 2, 1, '2026-05-29 17:37:29', '2026-05-29 17:37:29');
...
CREATE TABLE `asistencias` (
  ...
  `actividad_id` bigint(20) UNSIGNED NOT NULL,
  `atleta_id` int(11) UNSIGNED NOT NULL,
...
INSERT INTO `atletas` (`atleta_id`, `nombre`, `apellido`, `fecha_nac`, `sexo`, `cedula`, `telefono`, `pierna_dominante`, `direccion_id`, `representante_id`, `foto`, `estatus`, `creado_en`, `actualizado_en`) VALUES
(8, 'gabriel', 'rivas', '2010-10-10', 'M', 'V-43.241.212', '04122132121', 'derecha', 13, 8, NULL, 1, '2026-05-28 04:31:05', '2026-05-28 06:17:35'),
(9, 'adrian', 'rivas', '2015-02-20', 'M', 'V-42343242', '04125654435', 'ambidiestro', 14, 9, NULL, 1, '2026-05-28 04:37:01', '2026-05-30 00:18:02'),
(10, 'gabriel', 'mendoza', '2020-05-21', 'M', 'P-312213211', '04124212323', NULL, 15, 10, NULL, 3, '2026-05-28 05:43:14', '2026-05-30 02:00:42'),
(11, 'carlos', 'Pinto', '2015-12-12', 'M', 'N-2012-10346', '04123121211', NULL, 16, 11, NULL, 1, '2026-05-28 12:41:02', '2026-05-30 01:11:52'),
(12, 'pedro', 'Pinto', '2002-12-12', 'M', 'V-12312312', '04123123123', NULL, 17, 12, NULL, 1, '2026-05-28 13:03:11', '2026-05-30 00:17:23'),
(13, 'Omar', 'Pinto', '2000-02-20', 'M', 'V-32123123', '04122312321', 'derecha', 19, 13, NULL, 1, '2026-05-29 15:09:23', '2026-05-30 00:16:53'),
(14, 'fabial', 'flavio', '1999-10-10', 'M', 'E-1231231231', '02553241212', NULL, 20, 14, NULL, 0, '2026-05-29 16:12:49', '2026-05-30 02:12:03'),
(15, 'adrian', 'rivas', '2000-10-10', 'M', 'P-412AQ21', '02564123131', 'derecha', 21, 15, NULL, 1, '2026-05-29 23:24:51', '2026-05-30 02:47:09');
...
INSERT INTO `categorias` (`categoria_id`, `nombre_categoria`, `sexo_categoria`, `edad_min`, `edad_max`, `usuario_id`, `estatus`, `creado_en`, `actualizado_en`) VALUES
(1, 'sub-12(m)', 'M', 10, 12, 8, 1, '2026-05-25 19:40:17', '2026-05-28 19:36:33'),
(2, 'sub-18(f)', 'F', 16, 18, 6, 1, '2026-05-26 14:24:01', '2026-05-28 04:38:07'),
(3, 'sub-14(m)', 'M', 12, 14, 4, 1, '2026-05-26 21:00:25', '2026-05-28 12:59:36'),
(4, 'sub-8(mix)', 'X', 6, 8, 5, 1, '2026-05-28 03:46:34', '2026-05-29 17:25:12'),
(5, 'sub-16(m)', 'M', 14, 16, 4, 1, '2026-05-28 04:38:26', '2026-05-28 04:38:26'),
(7, 'sub-10(m)', 'M', 8, 10, 4, 1, '2026-05-28 12:38:24', '2026-05-28 12:38:24'),
(8, 'sub-14(mix)', 'X', 12, 14, 6, 1, '2026-05-28 19:32:01', '2026-05-28 19:32:01'),
(9, 'sub-12(mix)', 'X', 10, 12, 6, 1, '2026-05-28 20:57:00', '2026-05-28 20:57:00'),
(13, 'sub-18(mix)', 'X', 16, 18, 6, 1, '2026-05-29 15:08:22', '2026-05-29 15:08:22'),
(14, 'sub-40(mix)', 'X', 19, 40, 5, 1, '2026-05-29 15:10:57', '2026-05-29 15:10:57'),
(15, 'sub-50(f)', 'F', 40, 50, 5, 1, '2026-05-29 15:18:24', '2026-05-29 15:18:24'),
(16, 'sub-50(mix)', 'X', 40, 50, 5, 1, '2026-05-29 15:21:15', '2026-05-29 15:21:15'),
(17, 'sub-40(m)', 'M', 19, 40, 5, 1, '2026-05-29 15:23:11', '2026-05-29 15:23:11');
...
(1, 'tiempo_sesion', '120', 'Tiempo de expiración de sesión en minutos', '2026-05-28 21:12:00'),
...
CREATE TABLE `direcciones` (
  `direccion_id` bigint(20) UNSIGNED NOT NULL,
  `parroquias_id` smallint(6) NOT NULL,
...
(2, 302, '123', 'edificio', 'wqd'),
(3, 269, 'prados', 'casa', 'nose'),
(4, 486, 'prados', 'apto', 'nose'),
(5, 739, 'durigua 4', 'casa', 'casa 4'),
(6, 163, 'los cortijos', 'casa', 'asdgasw'),
(7, 575, 'los caobos', 'casa', 'mijaguito'),
(8, 722, 'villa del pilar', 'apto', 'calle 2 apto 1-24'),
(9, 987, 'villa del pilar', 'casa', 'calle 2 apto 1-24'),
(10, 739, 'goajira', 'apto', 'calle 14A'),
(11, 26, 'goajira', 'casa', 'calle 2 apto 1-24'),
(12, 91, 'dsadsad', 'apto', 'dsad'),
(13, 460, 'goajira', 'apto', 'calle 15A'),
(14, 576, 'barrio guaicaipuro', 'casa', 'calle 15A'),
(15, 986, 'goajira', 'apto', 'calle 15A'),
(16, 576, 'barrio guaicaipuro', 'casa', 'mijaguito'),
(17, 576, 'barrio guaicaipuro', 'casa', 'calle 15A'),
(18, 739, 'localidad', 'casa', 'direecion'),
(19, 641, 'barrio guaicaipuro', 'casa', 'calle 15A'),
(20, 452, 'barrio guaicaipuro', 'casa', 'calle 15A'),
(21, 641, 'el mamon', 'casa', 'calle 2 apto 1-24');
...
CREATE TABLE `discapacidades` (
  ...
  `ficha_id` int(11) UNSIGNED NOT NULL,
  `tipo_discapacidad_id` smallint(6) NOT NULL,
  `nro_carnet` varchar(20) DEFAULT NULL,
  `porcentaje_discapacidad` tinyint(4) DEFAULT NULL,
...
CREATE TABLE `fichas_medicas` (
  ...
  `alergias` varchar(100) DEFAULT NULL COMMENT 'Medicamentos, alimentos o ambientales',
  `antecedentes_familiares` varchar(100) DEFAULT NULL COMMENT 'Problemas cardíacos, diabetes, etc.',
  `antecedentes_quirurgicos` varchar(100) DEFAULT NULL COMMENT 'Cirugías previas',
  `condicion_cronica` varchar(100) DEFAULT NULL COMMENT 'Asma, diabetes, etc.',
...
INSERT INTO `fichas_medicas` (`ficha_id`, `atleta_id`, `grupo_sanguineo`, `alergias`, `antecedentes_familiares`, `antecedentes_quirurgicos`, `condicion_cronica`, `medicacion_actual`, `creado_en`, `actualizado_en`) VALUES
(3, 8, 'B+', '', '', '', '', '', '2026-05-28 08:32:14', '2026-05-28 08:32:14'),
(4, 10, 'B+', 'polen', '', '', '', '', '2026-05-28 19:48:09', '2026-05-30 02:01:16');
...
CREATE TABLE `medidas_antropometricas` (
  `medidas_id` int(11) UNSIGNED NOT NULL,
  `atleta_id` int(11) UNSIGNED NOT NULL,
...
INSERT INTO `medidas_antropometricas` (`medidas_id`, `atleta_id`, `fecha_medicion`, `peso`, `altura`, `porcentaje_grasa`, `porcentaje_musculatura`, `envergadura`, `largo_de_pierna`, `largo_de_torso`, `creado_en`) VALUES
(6, 8, '2026-05-28 00:00:00', 45.00, NULL, NULL, NULL, NULL, NULL, NULL, '2026-05-28 08:32:24');
...
CREATE TABLE `municipios` (
  `municipio_id` smallint(11) NOT NULL,
  `estado_id` smallint(11) NOT NULL,
...
CREATE TABLE `parroquias` (
  `parroquia_id` smallint(6) NOT NULL,
  `municipio_id` smallint(6) NOT NULL,
...
--
-- Estructura de tabla para la tabla `posiciones_juegos`
--

CREATE TABLE `posiciones_juegos` (
  `posicion_id` tinyint(4) NOT NULL,
  `nombre_posicion` varchar(50) NOT NULL,
  `descripcion` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `posiciones_juegos`
--

INSERT INTO `posiciones_juegos` (`posicion_id`, `nombre_posicion`, `descripcion`) VALUES
(1, 'Portero', 'Encargado de defender la portería, único que puede usar las manos.'),
(2, 'Defensa Central', 'Defensor principal en el centro de la zaga.'),
(3, 'Lateral Derecho', 'Defensor por la banda derecha con proyección al ataque.'),
(4, 'Lateral Izquierdo', 'Defensor por la banda izquierda con proyección al ataque.'),
(5, 'Mediocentro Defensivo', 'Encargado de recuperar balones y equilibrio en el medio campo.'),
(6, 'Mediocentro Ofensivo', 'Encargado de la creación de juego y asistencia a delanteros.'),
(7, 'Extremo Derecho', 'Atacante veloz por la banda derecha.'),
(8, 'Extremo Izquierdo', 'Atacante veloz por la banda izquierda.'),
(9, 'Delantero Centro', 'Principal referente de ataque y goleador del equipo.');
...
INSERT INTO `representantes` (`representante_id`, `nombre`, `apellido`, `telefono`, `cedula`, `tipo_relacion`, `direccion_id`, `foto`, `creado_en`, `actualizado_en`) VALUES
(1, 'sad', 'asd', '04122131231', 'V-21.312.321', 'tio/a', 2, NULL, '2026-05-25 19:41:36', '2026-05-25 19:41:36'),
(2, 'Luis', 'A Colmenarez', '04241231234', 'V-27.414.005', 'padres', 3, NULL, '2026-05-26 11:59:54', '2026-05-26 12:03:26'),
(3, 'maria', 'maria', '04123123412', 'V-3.213.123', 'abuelo/a', 4, NULL, '2026-05-26 14:25:25', '2026-05-26 14:25:25'),
(4, 'maria', 'mendoza', '04121231242', 'E-12.443.243', 'padres', 7, NULL, '2026-05-26 21:04:14', '2026-05-26 21:04:14'),
(5, 'tera', 'palacios', '04121234567', 'V-12.345.678', 'padres', 9, NULL, '2026-05-26 23:14:19', '2026-05-26 23:14:19'),
(6, 'Juanito', 'Perez', '04145231462', 'V-12.708.565', 'abuelo/a', 10, NULL, '2026-05-26 23:18:41', '2026-05-26 23:19:29'),
(7, 'dsad', 'dsf', '04122321312', 'V-3.123.123', 'hermano/a', 12, NULL, '2026-05-28 00:55:15', '2026-05-28 00:55:15'),
(8, 'tera', 'Perez', '04121212134', 'V-4.123.211', 'tio/a', 13, NULL, '2026-05-28 04:31:05', '2026-05-28 04:31:05'),
(9, 'Juanito', 'Perez', '04123123123', 'V-41214214', 'hermano/a', 14, NULL, '2026-05-28 04:37:01', '2026-05-30 00:18:02'),
(10, 'tera', 'Perez', '04123213121', 'P-32311', 'abuelo/a', 15, NULL, '2026-05-28 05:43:14', '2026-05-28 07:51:30'),
(11, 'Juanito', 'Perez', '04163123123', 'P-12341231', 'padres', 16, NULL, '2026-05-28 12:41:02', '2026-05-28 12:41:02'),
(12, 'Juanito', 'Perez', '04121232134', 'V-23131232', 'padres', 17, NULL, '2026-05-28 13:03:11', '2026-05-30 00:17:23'),
(13, 'Juanito', 'palacios', '04122132131', 'V-23241121', 'primo/a', 19, NULL, '2026-05-29 15:09:23', '2026-05-30 00:16:53'),
(14, 'tera', 'Perez', '02564411213', 'V-23123112', 'abuelo/a', 20, NULL, '2026-05-29 16:12:49', '2026-05-29 23:29:40'),
(15, 'tera', 'palacios', '04125434232', 'P-31AA412', 'representante', 21, NULL, '2026-05-29 23:24:51', '2026-05-29 23:27:32');
...
INSERT INTO `respuestas_seguridad` (`respuesta_id`, `usuario_id`, `pregunta_id`, `respuesta`, `creado_en`, `actualizado_en`) VALUES
(1, 1, 2, '$2y$12$/BAweuWk4GkSlBMO5l9uYemeLO1Z39ojBKMN6knLeiistLejnidXK', '2026-05-25 19:39:32', '2026-05-25 19:39:32'),
(2, 1, 8, '$2y$12$BENvEWyEyG2rniFuONx5buRtQZOnwkD.8G1VG2ar/7ZvYybnbJtAm', '2026-05-25 19:39:32', '2026-05-25 19:39:32'),
(3, 4, 4, '$2y$12$Abl9ktPGxV00chPTa9Ti6eMPYjGq7GF86MD2bS/rGTJgrgeS9BjpW', '2026-05-26 17:26:05', '2026-05-26 17:26:05'),
(4, 4, 2, '$2y$12$WykbEqzJnh/Kwk2FRdxE8uz7y1ypML8.hJZNqHN12.FyD8OTh33P2', '2026-05-26 17:26:06', '2026-05-26 17:26:06'),
(5, 3, 8, '$2y$12$rcafxHVjb/AWHMGdUAxzTev35HSmuql82Bq0CmC2d3SMmaCASqc7W', '2026-05-26 19:01:49', '2026-05-26 19:01:49'),
(6, 3, 10, '$2y$12$Gt7MAVKtrUZCqrwTlKJfvOBnQrnRTvRpe3uvx6bxPea00mXJYAKW6', '2026-05-26 19:01:50', '2026-05-26 19:01:50'),
(7, 2, 3, '$2y$12$ehxioGJdRACLIICsWyF4q.GTmvlZVSeptjyMPFNvVrKupL/6nJI4a', '2026-05-26 19:10:25', '2026-05-26 19:10:25'),
(8, 2, 6, '$2y$12$kyVvdaidqbDk5pGhekK5Eel33CtyULb2OjEf36MAYV8G3lO2jhmt2', '2026-05-26 19:10:26', '2026-05-26 19:10:26');
...
INSERT INTO `resultados_pruebas` (`test_id`, `actividad_id`, `atleta_id`, `test_de_fuerza`, `test_resistencia`, `test_velocidad`, `test_coordinacion`, `test_de_reaccion`, `creado_en`) VALUES
(6, 12, 8, 34.00, 700.00, 4.50, 25.00, 290.00, '2026-05-28 08:32:38'),
(7, 13, 8, 30.00, 1000.00, 5.00, 19.00, 300.00, '2026-05-29 12:53:03'),
(8, 14, 10, 20.00, 600.00, 5.20, 22.00, 400.00, '2026-05-29 12:54:35'),
(9, 15, 10, 23.00, 900.00, 5.00, 22.00, 400.00, '2026-05-29 12:55:58');
...
(1, 'superusuario@gmail.com', '$2y$12$PO2oFltFwFOACOp466Et6uePxLDY/aHoxJMz/9YIS7XmwpIPWth/S', NULL, 1, 'Activo', 'Super', 'Usuario', '11111111', '', '0000-00-00', 1, NULL, '2026-05-30 02:51:41', '2026-05-09 03:17:04', '2026-05-30 02:51:41'),
(2, 'administrador@gmail.com', '$2y$12$UoiVrtehmwgJBXkfwmKLTeECwsQkURRiYBJhjai2MR/hRJ2VFOWKu', NULL, 2, 'Activo', 'Administrador', 'Prueba', '22222222', '', '0000-00-00', 1, NULL, '2026-05-28 13:11:13', '2026-05-09 03:17:04', '2026-05-28 13:11:13'),
(3, 'entrenador@gmail.com', '$2y$12$60fSrhIfsWx0p2kzrWHzBuAqoD/CmHep0yEsYIjoFLEvU.J34alt6', NULL, 3, 'Activo', 'Entrenador', 'Prueba', '33333333', '', '0000-00-00', 1, NULL, '2026-05-26 19:01:01', '2026-05-09 03:17:04', '2026-05-26 19:01:49'),
(4, 'nicol@gmail.com', '$2y$12$WdSUjBHadlwLH11m/MOY9O4cxXReRbEWBlheQuRQ4DP6QomsUQ/.6', NULL, 3, 'Activo', 'nicol', 'nicol', '30239788', '04145165639', '2003-07-12', 5, NULL, '2026-05-26 17:24:22', '2026-05-26 17:22:28', '2026-05-26 17:26:05'),
(5, 'entre@g.com', '$2y$12$WKo5uFYSNcJ49EZr/k67yeoQKrbsJaG4fjAr6Hy2JYvgm5A6F3r2m', NULL, 3, 'Activo', 'pedro', 'alvarez', 'P-32131', '04121236432', '2000-10-10', 6, '/uploads/usuarios/670820d81e583efe.jpg', NULL, '2026-05-26 18:59:09', '2026-05-28 07:57:30'),
(6, 'kelvis@gmail.com', '$2y$12$WYCCqEl3GYknAcMFulZJbeRtT.kItZ9mzExgPh7AKTB6whRjlWRkq', NULL, 3, 'Activo', 'kelvis', 'gomez', '16423578', '04124346547', '1999-01-01', 8, '/uploads/usuarios/556d04e413c945d2.jpg', NULL, '2026-05-26 21:37:42', '2026-05-26 21:37:42'),
(7, 'hola@gmail.com', '$2y$12$MVVgpeIQXVJk54CFWBVrqet.dj9OZpzVMkgfOI1iEiYf7R.3QOnsG', NULL, 2, 'Activo', 'gabriel', 'mendoza', '12234123', '04121234124', '2008-05-26', 11, NULL, NULL, '2026-05-26 23:33:46', '2026-05-26 23:33:46'),
(8, 'carloscabreras2022@gmail.com', '$2y$12$chse9j10QbxwEcODPvhO8esbzm06E9GOFGmCXh2wToefdbVONkveq', NULL, 3, 'Activo', 'Carlos', 'Perez', 'V-19.188.137', '04121556442', '1987-11-24', 18, NULL, NULL, '2026-05-28 19:35:42', '2026-05-28 19:35:42');
...
--
-- Indices de la tabla `posiciones_juegos`
--
ALTER TABLE `posiciones_juegos`
...
ALTER TABLE `tipos_discapacidades`
  ADD PRIMARY KEY (`tipo_discapacidad_id`);
...
ALTER TABLE `usuarios`
  ...
  ADD UNIQUE KEY `email_unico` (`correo`),
  ADD KEY `rol` (`rol_id`),
  ADD KEY `direccion` (`direccion_id`);
...
--
ALTER TABLE `actividades`
  MODIFY `actividad_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `asig_categorias`
--
ALTER TABLE `asig_categorias`
  MODIFY `asignacion_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `asistencias`
--
ALTER TABLE `asistencias`
  MODIFY `asistencia_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `atletas`
--
ALTER TABLE `atletas`
  MODIFY `atleta_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de la tabla `categorias`
--
ALTER TABLE `categorias`
  MODIFY `categoria_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `direcciones`
  MODIFY `direccion_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT de la tabla `discapacidades`
--
ALTER TABLE `discapacidades`
  MODIFY `discapacidad_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `estados`
--
ALTER TABLE `estados`
  MODIFY `estado_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT de la tabla `fichas_medicas`
--
ALTER TABLE `fichas_medicas`
  MODIFY `ficha_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `medidas_antropometricas`
  MODIFY `medidas_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `municipios`
--
ALTER TABLE `municipios`
  MODIFY `municipio_id` smallint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=464;

--
-- AUTO_INCREMENT de la tabla `parroquias`
--
ALTER TABLE `parroquias`
  MODIFY `parroquia_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1140;

--
-- AUTO_INCREMENT de la tabla `posiciones_juegos`
--
ALTER TABLE `posiciones_juegos`
  MODIFY `posicion_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `preguntas_seguridad`
--
ALTER TABLE `preguntas_seguridad`
  MODIFY `pregunta_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `representantes`
--
ALTER TABLE `representantes`
  MODIFY `representante_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `resultados_pruebas`
  MODIFY `test_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `usuarios`
  MODIFY `usuario_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `asistencias`
  ADD CONSTRAINT `asistencias_ibfk_6` FOREIGN KEY (`atleta_id`) REFERENCES `atletas` (`atleta_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `asistencias_ibfk_7` FOREIGN KEY (`actividad_id`) REFERENCES `actividades` (`actividad_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `discapacidades`
  ADD CONSTRAINT `discapacidades_ibfk_3` FOREIGN KEY (`ficha_id`) REFERENCES `fichas_medicas` (`ficha_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `discapacidades_ibfk_4` FOREIGN KEY (`tipo_discapacidad_id`) REFERENCES `tipos_discapacidades` (`tipo_discapacidad_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `medidas_antropometricas`
  ADD CONSTRAINT `medidas_antropometricas_ibfk_1` FOREIGN KEY (`atleta_id`) REFERENCES `atletas` (`atleta_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `municipios`
--
ALTER TABLE `municipios`
  ADD CONSTRAINT `municipios_ibfk_1` FOREIGN KEY (`estado_id`) REFERENCES `estados` (`estado_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
--
ALTER TABLE `respuestas_seguridad`
  ADD CONSTRAINT `respuestas_seguridad_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`usuario_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `respuestas_seguridad_ibfk_2` FOREIGN KEY (`pregunta_id`) REFERENCES `preguntas_seguridad` (`pregunta_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `resultados_pruebas`
--
ALTER TABLE `resultados_pruebas`
  ADD CONSTRAINT `resultados_pruebas_ibfk_4` FOREIGN KEY (`actividad_id`) REFERENCES `actividades` (`actividad_id`),
  ADD CONSTRAINT `resultados_pruebas_ibfk_5` FOREIGN KEY (`atleta_id`) REFERENCES `atletas` (`atleta_id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `usuarios_ibfk_2` FOREIGN KEY (`direccion_id`) REFERENCES `direcciones` (`direccion_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `usuarios_ibfk_3` FOREIGN KEY (`rol_id`) REFERENCES `roles_usuarios` (`rol_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
