...
<div class="page-header">
    ...
    <a href="<?= e(url('/admin/asistencias/pase')) ?>" class="btn btn-primary">
    ...
    <table class="data-table">
        ...
        <?php foreach ($eventos as $ev): ?>
            <tr>
                ...
                <td>
                    <?php 
                        $label = match ((int)($ev['tipo_evento'] ?? 1)) {
                            0 => 'Partido',
                            1 => 'Entrenamiento',
                            3 => 'Evento Especial',
                            default => 'General'
                    ...
                    ?>
                    <span class="badge badge-primary" style="text-transform: uppercase; font-size: 11px;"><?= e($label) ?></span>
                </td>
                <td>
                ...
                <td>
                    <div style="display: flex; align-items: center; gap: 8px;">
                        <div style="width: 100px; height: 8px; background: var(--color-surface-2); border-radius: 4px; overflow: hidden;">
        ...
        <?php if (empty($eventos)): ?>
            <tr>
                <td colspan="5" class="text-center text-muted" style="padding: 48px;">
                    <i class="ph ph-calendar-x" style="font-size: 48px; opacity: 0.3; display: block; margin-bottom: 12px;"></i>
    ...
    document.querySelectorAll('.btn-delete-asistencia').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            CadaModal.confirm({
                ...
                text: `¿Estás seguro de eliminar el registro del día <strong>${date}</strong>? Esta acción no se puede deshacer.`,
                type: 'danger',
