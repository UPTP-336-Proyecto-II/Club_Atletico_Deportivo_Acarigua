...
final class ReportesController extends Controller
{
    public function index(Request $request): Response
    {
        ...
        $atletas = $db->query("SELECT a.atleta_id, a.nombre, a.apellido, a.cedula, a.estatus, a.categoria_id, c.nombre_categoria 
                               FROM atletas a 
        ...
        $categoriasList = $db->query("SELECT categoria_id, nombre_categoria FROM categorias WHERE estatus='activa' ORDER BY nombre_categoria")->fetchAll();
